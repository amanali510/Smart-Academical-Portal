...
<html lang="en">
    ...
    <body class="">
        <div class="main-wrapper">
            ...
            <div class="login-bg-color" style="background-color:#882681;">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Smart Academical Portal</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result-parent.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter your Parent id</label>
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small style="color:white">Smart Academical Portal</small></p>
                    </div>
